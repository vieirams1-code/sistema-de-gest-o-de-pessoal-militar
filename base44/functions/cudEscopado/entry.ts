...
const PERMISSIONS_MAP = {
  ...
  MilitarTag: {
    create: 'gerenciar_tags_militar',
    update: 'gerenciar_tags_militar',
    remover: 'gerenciar_tags_militar',
    delete: 'gerenciar_tags_militar',
  },
  FeriasTag: {
    create: 'gerenciar_tags_ferias',
    update: 'gerenciar_tags_ferias',
    remover: 'gerenciar_tags_ferias',
    delete: 'gerenciar_tags_ferias',
  },
  FuncaoMilitar: {
