...
export default function UploadMigracaoMilitares({ file, onFileChange, onAnalisar, loading }) {
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="font-semibold text-slate-800">Upload do arquivo legado</h2>
          <p className="text-sm text-slate-500">Envie um arquivo CSV ou Excel (.xlsx) com os dados dos militares.</p>
        </div>
      </div>
