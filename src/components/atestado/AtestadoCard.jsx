...
export default function AtestadoCard({ atestado, onEdit, onDelete, onView }) {
  ...
  const getStatusInfo = () => {
    ...
    if (atestado.status === 'Encerrado' || atestado.status === 'Cancelado') {
      return null;
    }
    ...
    if (diasRestantes < 0) {
      ...
      return {
        icon: Clock,
        text: `Retorna em ${diasRestantes} ${diasRestantes === 1 ? 'dia' : 'dias'}`,
      ...
      return {
        icon: CheckCircle,
        text: `Retorna em ${diasRestantes} dias`,
    ...
    >
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          ...
          <Badge className={tipoColors[atestado.tipo] || tipoColors['Outro']}>
            {atestado.tipo}
          </Badge>
