...
export async function atualizarEstadoAtestadoPelasPublicacoes(atestadoId, atestadoEntity, publicacaoEntity, atualizarEscopadoFn) {
  ...
  if (typeof atualizarEscopadoFn === 'function') {
    await atualizarEscopadoFn('Atestado', atestadoId, estadoDerivado);
  } else {
...
export async function reverterAtestadosPorExclusaoPublicacao(publicacaoExcluida, atestadoEntity, publicacaoEntity, atualizarEscopadoFn) {
  ...
  for (const atestadoId of atestadoIds) {
    ...
    if (typeof atualizarEscopadoFn === 'function') {
      await atualizarEscopadoFn('Atestado', atestadoId, payload);
    } else {
