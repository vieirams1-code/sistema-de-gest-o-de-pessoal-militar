...
export const VARS_PREVIEW = buildPreviewTemplateVars({
  ...
  comportamento: 'Ótimo',
  comportamento_calculado: 'Ótimo',
  comportamento_cadastrado: 'Bom',
  data_alteracao: '01/03/2026',
  posto_nome: '1º SGT QBMP 1.a João da Silva',
  posto: '1º SGT',
  quadro: 'QBMP 1.a',
  quadro_nome: 'QBMP 1.a',
  militar_quadro: 'QBMP 1.a',
  data_inicio_comportamento: '25/11/2019',
  data_vigencia: '25/11/2019',
  tipo_publicacao_comportamento: 'registro_funcional_comportamento',
