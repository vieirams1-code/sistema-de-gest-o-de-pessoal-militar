...
export async function registrarAjustePeriodoAquisitivo({
  ...
  return {
    periodoId,
    dias_ajuste_anterior: ajusteAtual,
    dias_ajuste_atual: novoAjuste,
    dias_total_projetado: validacao.dias_total_projetado,
    dias_saldo_projetado: validacao.dias_saldo_projetado,
  };
}
