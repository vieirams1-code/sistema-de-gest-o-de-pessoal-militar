...
export default function FuncoesTagsManager({ canEdit = true, initialTab = 'funcoes' }) {
  ...
  const salvarTag = () => {
    ...
    const payload = { ...formTag, tipo_visual: tipoVisual, tipo_uso: normalizarTipoUsoTag(formTag.tipo_uso), aplicabilidade: normalizarAplicabilidade(formTag.aplicabilidade), ativo: editandoTag?.ativo ?? true };
