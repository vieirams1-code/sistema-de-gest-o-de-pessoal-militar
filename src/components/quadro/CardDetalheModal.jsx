      ...
      <div className="relative h-full w-full max-w-[560px] bg-white shadow-2xl flex flex-col overflow-hidden border-l border-slate-200">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          ...
          <div className={`space-y-3 rounded-lg p-3 border ${card.aguardando_decisao ? 'bg-amber-50 border-amber-200' : 'bg-slate-50 border-slate-100'}`}>
            ...
            {(card.aguardando_decisao || card.encaminhado_em || card.devolvido_em || card.observacao_encaminhamento || card.observacao_devolucao) && (
            ...
            {!card.aguardando_decisao ? (
              ...
              <div className="space-y-2.5 border border-amber-200 bg-white rounded-md p-2.5">
                ...
                <div className="flex justify-end">
                  ...
                  >
                    {salvandoDecisao ? 'Salvando...' : 'Devolver decisão agora'}
                  </Button>
                </div>
              </div>
            )}
