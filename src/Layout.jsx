    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Controle de Processos', page: 'ControleProcessos', icon: FolderKanban, moduleKey: 'acesso_controle_processos', actionKey: 'perm_visualizar_controle_processos' },
        ],
      },
      {
        title: 'Saúde',
        ...
        items: [
          {
            ...
            icon: Megaphone,
            anyOf: [
              { type: 'action', key: 'perm_visualizar_campanhas_gerais' },
              { type: 'action', key: 'perm_criar_campanhas' },
              { type: 'action', key: 'perm_editar_campanhas' },
              { type: 'action', key: 'perm_excluir_campanhas' },
              { type: 'action', key: 'perm_gerir_campanhas' },
            ],
          ...
          },
          {
            ...
            anyOf: [
              { type: 'action', key: 'perm_configurar_portal' },
            ],
            menuGroup: 'Gestão RH / Comando',
          },
          {
