...
export default function VerAtestado() {
  ...
  if (loadingUser || !isAccessResolved || !isScopeReady) return null;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Dados do Médico */}
          {((atestado.medico_nome_snapshot || atestado.medico) || (atestado.medico_crm_snapshot || atestado.crm_medico) || atestado.tipo) && (
            <Section title="Informações Médicas" icon={Stethoscope}>
              <div className="space-y-2">
                <InfoItem label="Médico Responsável" value={atestado.medico_nome_snapshot || atestado.medico} />
                <InfoItem label="CRM do Médico" value={atestado.medico_crm_snapshot || atestado.crm_medico} />
