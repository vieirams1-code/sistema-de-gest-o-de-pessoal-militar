...
export default function AgendarJISO() {
  ...
  const { data: bundle = { atestados: [], jisos: [], meta: {} }, isLoading: isLoadingAtestados } = useQuery({
    queryKey: ['atestados-jiso-bundle', isAdmin, modoAcesso, userEmail, effectiveUserEmail || null],
    queryFn: async () => {
