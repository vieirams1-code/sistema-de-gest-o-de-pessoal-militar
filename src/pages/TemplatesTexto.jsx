...
const TIPOS_POR_MODULO = {
  'Livro': ['Saída Férias', 'Retorno Férias', 'Licença Maternidade', 'Prorrogação de Licença Maternidade', 'Licença Paternidade', 'Núpcias', 'Luto', 'Cedência', 'Transferência para RR', 'Trânsito', 'Instalação', 'Dispensa Recompensa', 'Dispensa Desconto Férias', 'Deslocamento Missão', 'Curso/Estágio', 'Designação de Função', 'Dispensa de Função'],
  'Publicação Ex Officio': ['Elogio Individual', 'Melhoria de Comportamento', 'Punição', 'Geral', 'Designação / Dispensa de Função', 'Ata JISO', 'Transcrição de Documentos', 'Interrupção de Férias', 'Transferência para RR', 'Homologação de Atestado'],
