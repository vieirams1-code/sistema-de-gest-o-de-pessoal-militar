    ...
    modules: [
      {
        ...
        actions: [
          ...
          { key: 'perm_gerenciar_tags_militar', label: 'Gerenciar Tags de Militares', sensitive: true },
          ...
          { key: 'perm_editar_metadados_contrato_designacao', label: 'Editar Contrato de Designação', sensitive: true },
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'perm_visualizar_plano_ferias', label: 'Visualizar Plano Anual de Férias' },
          { key: 'perm_visualizar_periodos_aquisitivos', label: 'Visualizar Períodos Aquisitivos' },
          { key: 'perm_gerar_periodos_aquisitivos', label: 'Gerar Períodos Aquisitivos', sensitive: true },
          { key: 'perm_editar_periodo_aquisitivo', label: 'Editar Período Aquisitivo', sensitive: true },
          { key: 'perm_alterar_status_periodo_aquisitivo', label: 'Alterar Status de Período Aquisitivo', sensitive: true },
          { key: 'perm_excluir_periodo_aquisitivo', label: 'Excluir Período Aquisitivo', sensitive: true },
          { key: 'perm_visualizar_creditos_ferias', label: 'Visualizar Créditos de Férias' },
          { key: 'perm_criar_credito_extra_ferias', label: 'Criar Crédito Extraordinário de Férias', sensitive: true },
          { key: 'perm_editar_credito_extra_ferias', label: 'Editar Crédito Extraordinário de Férias', sensitive: true },
          { key: 'perm_vincular_credito_extra_ferias', label: 'Vincular Crédito Extraordinário a Gozo de Férias', sensitive: true },
          { key: 'perm_remover_vinculo_credito_extra_ferias', label: 'Remover Vínculo de Crédito Extraordinário de Férias', sensitive: true },
          { key: 'perm_cancelar_credito_extra_ferias', label: 'Cancelar Crédito Extraordinário de Férias', sensitive: true },
          { key: 'perm_excluir_credito_extra_ferias', label: 'Excluir Crédito Extraordinário de Férias', sensitive: true },
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'perm_baixar_zip_atestados', label: 'Baixar ZIP de anexos de atestados', sensitive: true }
        ]
      },
      {
    ...
    modules: [
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'perm_indicar_medalhas', label: 'Indicar Medalhas em Fluxos de Apuração', sensitive: true },
    ...
    modules: [
      {
        ...
        actions: [
          ...
          { key: 'perm_visualizar_planos_ferias', label: 'Visualizar Planos Institucionais de Férias' },
