...
const ferias = {
  ...
  permissions: {
    canonical: {
      ...
      criar_credito_extra: 'criar_credito_extra_ferias',
      editar_credito_extra: 'editar_credito_extra_ferias',
      vincular_credito_extra: 'vincular_credito_extra_ferias',
      remover_vinculo_credito_extra: 'remover_vinculo_credito_extra_ferias',
      cancelar_credito_extra: 'cancelar_credito_extra_ferias',
      excluir_credito_extra: 'excluir_credito_extra_ferias',
    ...
    legacyPerm: {
      ...
      criar_credito_extra: 'perm_criar_credito_extra_ferias',
      editar_credito_extra: 'perm_editar_credito_extra_ferias',
      vincular_credito_extra: 'perm_vincular_credito_extra_ferias',
      remover_vinculo_credito_extra: 'perm_remover_vinculo_credito_extra_ferias',
      cancelar_credito_extra: 'perm_cancelar_credito_extra_ferias',
      excluir_credito_extra: 'perm_excluir_credito_extra_ferias',
  ...
  pageInternalChecks: {
    ...
    'pages/CreditosExtraordinariosFerias.jsx': [
      { check: "canAccessModule('ferias') && canAccessAction('visualizar_creditos_ferias')", effect: 'Permite consulta da tela de créditos extraordinários de férias' },
      { check: "canAccessAction('criar_credito_extra_ferias')", effect: 'Exibe CTA Novo crédito extraordinário e protege salvamento em modo criação' },
      { check: "canAccessAction('editar_credito_extra_ferias')", effect: 'Exibe ação Editar e protege salvamento em modo edição' },
      { check: "canAccessAction('vincular_credito_extra_ferias')", effect: 'Exibe ação Vincular gozo e protege handler de vínculo' },
      { check: "canAccessAction('remover_vinculo_credito_extra_ferias')", effect: 'Exibe ação Remover vínculo e protege handler de remoção de vínculo' },
      { check: "canAccessAction('cancelar_credito_extra_ferias')", effect: 'Exibe ação Cancelar e protege handler de cancelamento' },
      { check: "canAccessAction('excluir_credito_extra_ferias')", effect: 'Exibe ação Excluir e protege handler de exclusão' },
      { check: 'isCreditoBloqueadoPorUso / status cancelado / vínculo removível', effect: 'Mantém bloqueios internos já existentes além das actions granulares' },
    ],
  },
  componentsInternalChecks: {
...
const atestados = {
  ...
  pageInternalChecks: {
    ...
    'pages/ExtratoAtestadosMedicos.jsx': [
      ...
      { check: "canAccessAction('ver_dados_sensiveis_atestado')", effect: 'Controla a exposição dos campos clínicos sensíveis; não é pré-requisito oculto das capacidades de download.' },
      { check: "canAccessAction('baixar_anexos_atestados')", effect: 'PERM-ATEST-001: capacidade sensível própria para download individual; backend também exige visualizar_atestados e escopo.' },
      { check: "canAccessAction('baixar_zip_atestados')", effect: 'PERM-ATEST-001: capacidade sensível própria para download ZIP; backend também exige visualizar_atestados e escopo.' },
    ],
  },
  componentsInternalChecks: {
    'components/atestado/AtestadoCard': [
      ...
      { check: "canAccessAction('baixar_anexos_atestados')", effect: 'PERM-ATEST-001: download no menu de ações depende da capacidade específica de download, sem herdar ver_dados_sensiveis_atestado.' },
    ],
