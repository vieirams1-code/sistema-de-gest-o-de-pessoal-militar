...
export function parseDateSafe(value) {
  ...
  if (typeof value === 'string') {
    ...
    const brDateMatch = trimmed.match(BR_DATE_ONLY_REGEX);
    if (brDateMatch) {
      const [, dayRaw, monthRaw, yearRaw] = brDateMatch;
      return parseDateParts(Number(yearRaw), Number(monthRaw), Number(dayRaw));
    }
