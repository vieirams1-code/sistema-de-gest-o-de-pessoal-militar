...
const HEADER_ALIAS = {
  ...
  cid: ['cid'],
  data_inicio: ['data inicio', 'data início', 'data de inicio', 'data de início', 'data_inicio'],
  data_termino: ['data termino', 'data término', 'data de termino', 'data de término', 'data_termino'],
  dias: ['dias'],
  retorno: ['retorno', 'data retorno', 'data de retorno', 'data_retorno'],
  ...
  data_bg: ['data bg', 'data do bg', 'data de bg'],
  arquivo: ['arquivo'],
};
